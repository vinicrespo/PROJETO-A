...
export default function App() {
  React.useEffect(() => {
    ...
    s.src = "https://scripts.converteai.net/d21a9e1d-910e-4254-b2bc-30b12586d2ef/players/69f7a0fab24661ffe15b9f4e/v4/player.js";
    s.async = true;
      ...
      <div className="max-w-md mx-auto bg-white shadow-xl min-h-screen pb-8">
        ...
        <main className="px-4 py-4">
          ...
          <div className="w-full mb-6">
            {/* @ts-ignore */}
            <vturb-smartplayer id="vid-69f7a0fab24661ffe15b9f4e" style={{display: 'block', margin: '0 auto', width: '100%', maxWidth: '400px'}}></vturb-smartplayer>
          </div>

          {/* CTA Button (Hidden by default, shown by Vturb at specific pitch moment) */}
          <div className="w-full flex justify-center mb-6">
            <a href="https://checkout.kashpay.com.br/checkout/checkout-1777836330291" className="hide_39lead2 bg-[#22c55e] hover:bg-[#16a34a] text-white text-2xl font-black py-4 px-8 rounded-full w-full max-w-[400px] text-center shadow-[0_4px_14px_0_rgba(34,197,94,0.39)] hover:shadow-[0_6px_20px_rgba(34,197,94,0.23)] hover:-translate-y-1 transition-all duration-200 uppercase tracking-wide border-b-4 border-[#15803d] active:border-b-0 active:translate-y-0">
              Get Now
            </a>
          </div>
