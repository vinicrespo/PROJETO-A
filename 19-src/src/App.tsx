...
export default function App() {
  React.useEffect(() => {
    ...
    s.src = "https://scripts.converteai.net/d21a9e1d-910e-4254-b2bc-30b12586d2ef/players/6a3d949fac7ae1f318442a7b/v4/player.js";
    s.async = true;
      ...
      <div className="max-w-md mx-auto bg-white shadow-xl min-h-screen pb-8">
        ...
        <main className="px-4 py-4">
          ...
          <div className="w-full mb-6">
            {/* @ts-ignore */}
            <vturb-smartplayer id="vid-6a3d949fac7ae1f318442a7b" style={{display: 'block', margin: '0 auto', width: '100%', maxWidth: '400px'}}>
              <div className="vturb-player-placeholder" style={{position: 'relative', width: '100%', padding: '125% 0 0', zIndex: 0, backgroundColor: 'black'}}></div>
            </vturb-smartplayer>
          </div>
