...
export default function App() {
  React.useEffect(() => {
    ...
    s.src = "https://scripts.converteai.net/d21a9e1d-910e-4254-b2bc-30b12586d2ef/players/69f22989026646d4aa721494/v4/player.js";
    s.async = true;
