      ...
      <div className="max-w-md mx-auto bg-white shadow-xl min-h-screen pb-8">
        ...
        <main className="px-4 py-4">
          ...
          <div className="w-full flex flex-col items-center justify-center mb-6">
            {/* @ts-ignore */}
            <button onClick={() => window.acceptUpsell('https://app.kashpay.com.br/u/5e07a86bd0caad95')} className="hide_39upsell1" style={{fontFamily: 'Poppins', fontSize: '18px', fontWeight: '600', lineHeight: '1.3', color: '#ffffff', backgroundColor: '#057932', border: 'none', borderRadius: '10px', padding: '13px 7%', cursor: 'pointer', textAlign: 'center', display: 'block', margin: 'auto', marginBottom: '16px'}}>
              Get Now
            </button>
