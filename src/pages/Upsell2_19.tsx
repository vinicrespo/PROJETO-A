...
export default function Upsell2_19() {
  ...
  return (
    <div className="bg-black font-sans antialiased min-h-screen flex flex-col pt-[72px]">
      ...
      <main className="max-w-4xl mx-auto bg-black flex-1 w-full px-4 pt-12 pb-6 md:px-8">
        ...
        <section className="text-center mb-12 w-full hide-upsell2">
          <div className="flex flex-col items-center gap-4">
            <button 
              onClick={() => {
                // @ts-ignore
                window.acceptUpsell('https://app.kashpay.com.br/u/ab2528003d742a32');
              }} 
              style={{
                fontFamily: "'Poppins'",
                fontSize: '18px',
