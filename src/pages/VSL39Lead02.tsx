...
export default function VSL39Lead02() {
  ...
  useEffect(() => {
    ...
    vturbScript.src = "https://scripts.converteai.net/d21a9e1d-910e-4254-b2bc-30b12586d2ef/players/69dc44c98a1b9c7cc0582dfa/v4/player.js";
      ...
      <main className="max-w-4xl mx-auto bg-white flex-1 w-full px-4 pt-6 pb-6 md:px-8 shadow-sm">
        ...
        <section className="mb-8 flex justify-center w-full">
          <div className="w-full max-w-[400px] rounded-xl shadow-2xl overflow-hidden">
            <vturb-smartplayer id="vid-69dc44c98a1b9c7cc0582dfa" style={{ display: 'block', margin: '0 auto', width: '100%', maxWidth: '400px' }}></vturb-smartplayer>
          </div>
        </section>
