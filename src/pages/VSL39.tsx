...
export default function VSL39() {
  ...
  useEffect(() => {
    ...
    vturbScript.src = "https://scripts.converteai.net/d21a9e1d-910e-4254-b2bc-30b12586d2ef/players/69bddde66ced9201ea5405d2/v4/player.js";
      ...
      <main className="max-w-4xl mx-auto bg-white flex-1 w-full px-4 pt-6 pb-6 md:px-8 shadow-sm">
        ...
        <section className="mb-8 flex justify-center w-full">
          <div className="w-full max-w-[400px] sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl 2xl:max-w-3xl rounded-xl shadow-2xl overflow-hidden">
            <vturb-smartplayer id="vid-69bddde66ced9201ea5405d2" style={{ display: 'block', margin: '0 auto', width: '100%', height: '100%' }}></vturb-smartplayer>
          </div>
        </section>
