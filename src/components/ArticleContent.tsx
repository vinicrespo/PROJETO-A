...
export default function ArticleContent({ article }: ArticleContentProps) {
  ...
  return (
    <article className="w-full bg-white px-5 pt-6 pb-12 font-sans select-text">
      ...
      {/* Pricing Cards */}
      <div className="vsl hide w-full mt-10 mb-8 flex flex-col md:flex-row items-stretch justify-center space-y-8 md:space-y-0 md:space-x-6 max-w-6xl mx-auto font-sans relative">
        
        {/* Card 2: Best Seller (6 Bottles) -> DOM 1st, Desktop 2nd */}
        <div className="md:order-2 flex-1 flex flex-col bg-[#fff8e1] rounded-xl overflow-hidden shadow-[0_10px_30px_rgba(211,47,47,0.15)] relative z-10 border border-[#ffe082] w-full max-w-[340px] mx-auto md:transform md:-translate-y-2">
        ...
        {/* Card 3: Standard (3 Bottles) -> DOM 2nd, Desktop 3rd */}
        <div className="md:order-3 flex-1 flex flex-col bg-white rounded-xl overflow-hidden shadow-[0_0_15px_rgba(0,0,0,0.1)] border border-gray-100 w-full max-w-[340px] mx-auto">
        ...
        {/* Card 1: Starter (2 Bottles) -> DOM 3rd, Desktop 1st */}
        <div className="md:order-1 flex-1 flex flex-col bg-white rounded-xl overflow-hidden shadow-[0_0_15px_rgba(0,0,0,0.1)] border border-gray-100 w-full max-w-[340px] mx-auto">
          <div className="bg-[#D32F2F] text-white text-center py-2">
