    ...
    <div className="min-h-screen bg-gray-100 font-sans">
      ...
      <div className="max-w-md mx-auto bg-white shadow-xl min-h-screen pb-8">
        ...
        <main className="px-4 py-4">
          ...
          {/* VSL Video Placeholder (to be replaced with Vturb) */}
          <div className="w-full aspect-[4/5] bg-[#C14C8D] rounded-xl flex flex-col items-center justify-center text-white relative overflow-hidden shadow-sm mb-6">
            <h2 className="text-xl md:text-2xl font-bold mb-8 text-center px-4 leading-tight shadow-black/10 drop-shadow-md">
              Você já começou a assistir isso
            </h2>
            
            <button className="flex items-center gap-3 bg-transparent hover:bg-white/10 transition-colors px-6 py-3 rounded-full mb-2">
              <PlayCircle className="w-8 h-8" strokeWidth={1.5} />
              <span className="text-lg font-semibold drop-shadow-md">Continuar assistindo</span>
            </button>
            
            <button className="flex items-center gap-3 bg-transparent hover:bg-white/10 transition-colors px-6 py-3 rounded-full">
              <RotateCcw className="w-8 h-8" strokeWidth={1.5} />
              <span className="text-lg font-semibold drop-shadow-md">Assistir do início</span>
            </button>
          </div>
